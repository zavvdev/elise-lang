...
//!
//! The main idea is that our schema bindings
//! and data bindings have HashTable's with shared
//! keys that are represented as BindingPath. Because of
...
pub struct DataBinderDataDescriptor {
    ...
    // The idea behind BindingPath is that we use it as a
    // single source of truth for data access and type validation.
    // When we construct schema bindings from schema AST,
...
pub struct DataBindings {
    pub bindings: HashMap<BindingPath, DataBinderDataDescriptor>,
}
